...
export default function AdminNews() {
    ...
    const [form, setForm] = useState({ title: "", content: "", author: "", image: null, image_url: null });
    ...
    async function handleSubmit(e) {
        ...
        let body = { title: form.title, content: form.content, author: form.author || null };
        if (form.image) {
            const reader = new FileReader();
            reader.readAsDataURL(form.image);
            reader.onload = async () => {
                body.image = { data: reader.result.split(',')[1], type: form.image.type };
                try {
                    ...
                    if (!res.ok) throw new Error(`Failed to ${editing ? "update" : "create"} news`);
            ...
            <div className="max-w-6xl mx-auto space-y-10">
                ...
                <div className="flex justify-between items-center border-b pb-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Manage, create, and publish Andro Solutions updates</p>
                    </div>
                </div>
                {/* Add News Dialog */}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 mt-4 text-[#113559]">
                            ...
                            <div>
                                ...
                                {form.image_url && !form.image && (
                                    <p className="text-sm text-gray-500 mt-1">Current image: {form.image_url}</p>
                                )}
                            </div>
                                ...
                                >
                                    ...
                                    <CardContent>
                                        ...
                                        <p className="text-xs text-gray-500 mt-2">
                                            By {n.author || "Unknown"} • {new Date(n.created_at).toLocaleDateString()}
                                        </p>
